...
We introduce AWL to balance the loss
"""
...
class Trainer6():
    ...
    def train_epoch(self, reduce='mean'):
        ...
        for idx, data in enumerate(self.train_loader, 0):
            ...
            loss_list = [0.1 * recon_loss, 0.1 * kl_divergence, 1000 * height_loss, 1000 * waist_loss, laplacian_loss]
        ...
        loss_dict = {"Loss": epoch_losses, "Recon Loss": epoch_recon_losses, "KL Loss": epoch_kl_losses, 
                     "Height Loss": epoch_height_losses, "Waist Loss": epoch_waist_loss, "Laplacian Loss": epoch_laplacian_losses} 
