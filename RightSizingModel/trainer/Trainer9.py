...
class Trainer9():
    ...
    def train_epoch(self, reduce='mean'):
        ...
        for idx, data in enumerate(self.train_loader, 0):
            ...
            loss_list = [0.01 * (recon_loss + kl_divergence), 1000 * height_loss, 1000 * waist_loss, 1000 * chest_loss, 1000 * hip_loss, laplacian_loss]
            ...
            wandb.log({"Arm Loss": 1000 * hip_loss.item()})
