...
def mesh_sampling_method(data_fp, template_fp, ds_factors, device):
    """
    data_fp: path to the data folder
    template_fp: path to the template mesh
    ds_factors: downsample factors. The default value is [4, 4, 4, 4]
    device: torch.device
    """
